...
class Lexer(object):
    ...
    keywords = {'def': 'DEF',
                'var': 'VAR', 'bool': 'BOOL', 'int': 'INT', 'null': 'NULL',
                'if': 'IF', 'else': 'ELSE',
                'while': 'WHILE', 'return': 'RETURN',
                'break': 'BREAK', 'continue': 'CONTINUE',
                'true': 'TRUE', 'false': 'FALSE', 'void': 'VOID',
                'struct': 'STRUCT', 'type': 'TYPE', 'alloc': 'ALLOC'}

    tokens = (
        'PLUS', 'MINUS', 'SEMICOLON', 'LPAREN', 'RPAREN', 'IDENT', 'NUMBER',
        'LBRACE', 'RBRACE', 'COMMA',
        'BITSHL', 'BITSHR', 'BITXOR', 'BITOR', 'BITAND', 'UBITAND',
        'TIMES', 'DIV', 'MODULUS', 'UMINUS', 'BITCOMPL',
        'ASSIGN', 'COLON', 'OR', 'AND', 'EQUAL', 'DIFFERENT',
        'LESS', 'MORE', 'LESSEQ', 'MOREEQ', 'NOT', 'REF', 'DEREF', 'DOT',
        'LBRACKET', 'RBRACKET', 'BRACKETS', 'TO'
