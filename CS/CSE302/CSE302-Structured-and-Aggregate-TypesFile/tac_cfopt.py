...
from tac2x64 import tac_str, Alloc
    ...
    for now in js_obj:
        if "proc" in now.keys():
            ...
            for line in now["body"]:
                op = line["opcode"]
                if (op == "load" or op == 'getaddress_var' or op == 'getaddress_array' or op == 'load_globl'):
                    arg1 = line["args"]
                    arg2 = None
                    if (arg1[0] == None):
                        arg1[0] = 0
